...
urlpatterns = [
    ...
    path("compare/result/", views.compare_result_view, name="compare_result"),
    path("download_compare/", views.download_compare_view, name="download_compare"),
    path("outline/", views.outline_view, name="outline"),
    path("outline/result/", views.outline_result_view, name="outline_result"),
    path("download_outline/", views.download_outline_view, name="download_outline"),
    path("share/", views.share_links_view, name="share_links"),
