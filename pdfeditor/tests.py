...
class PDFProcessorTests(TestCase):
    ...
    def test_find_and_replace_basic(self):
        ...
        output_path, count, warnings = find_and_replace_text(
            pdf_path=self.test_pdf_text, search_text="test", replace_text="exemplu", case_sensitive=False
        )
    ...
    def test_find_and_replace_case_sensitive(self):
        ...
        output_path, count, warnings = find_and_replace_text(
            pdf_path=self.test_pdf_text, search_text="test", replace_text="exemplu", case_sensitive=True
        )
