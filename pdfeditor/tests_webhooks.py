...
class WebhookDeliveryTests(TestCase):
    ...
    def test_2xx_marks_success_and_resets_failures(self):
        ...
        with patch("pdfeditor.tasks.requests.post", return_value=resp) as post:
    ...
    def test_inactive_webhook_is_not_delivered(self):
        ...
        with patch("pdfeditor.tasks.requests.post") as post:
    ...
    def test_non_2xx_triggers_a_retry(self):
        ...
        with patch("pdfeditor.tasks.requests.post", return_value=resp), self.assertRaises(Retry):
    ...
    def test_disable_after_retries_exhausted_and_max_failures(self):
        ...
        resp = MagicMock(status_code=500)
        with patch("pdfeditor.tasks.requests.post", return_value=resp):
