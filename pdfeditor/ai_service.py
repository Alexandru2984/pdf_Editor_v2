...
class AIProvider:
    ...
    def rephrase(
        self, text: str, style: str, model: str, custom_prompt: str | None = None
    ) -> tuple[str, bool, str]:
        raise NotImplementedError
...
def _build_prompt(text: str, style: str, custom_prompt: str | None) -> str:
    prompt_text = custom_prompt or REPHRASE_STYLES.get(style, REPHRASE_STYLES["formal"])["prompt"]
    return f"{prompt_text}\n\nText to rephrase:\n{text}\n\nRephrased text:"


def _groq_payload(text: str, style: str, model: str, custom_prompt: str | None) -> dict[str, Any]:
    prompt_text = custom_prompt or REPHRASE_STYLES.get(style, REPHRASE_STYLES["formal"])["prompt"]
    return {
        "messages": [
            {
...
def get_all_models() -> dict[str, list[str]]:
    ...
    return {"ollama": ollama, "groq": groq}
