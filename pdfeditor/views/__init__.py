...
__all__ = [
    'serve_media_view',
    'dashboard_view', 'upload_view', 'delete_pdf_view',
    'edit_view', 'result_view', 'download_view', 'preview_view',
    'split_view', 'split_result_view', 'download_split_file_view',
    'merge_view', 'merge_result_view', 'download_merged_view',
    'compress_view', 'compress_result_view', 'download_compressed_view',
    'watermark_view', 'watermark_result_view', 'download_watermarked_view',
    'rotate_view', 'rotate_result_view', 'download_rotated_view',
